...
const PANEL_URL=cleanPanel(process.env.PANEL_URL),AGENT_DOMAIN=String(process.env.AGENT_DOMAIN||'').trim(),VERSION=process.env.AGENT_VERSION||'0.6.1',PROXY_PORT=Number(process.env.AGENT_PROXY_PORT||8080);
