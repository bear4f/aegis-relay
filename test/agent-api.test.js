...
function request(url,body,headers={}){const req=Readable.from([Buffer.from(body)]);req.url=url;req.method='POST';req.headers=headers;req.socket={remoteAddress:'127.0.0.1'};return req;}
